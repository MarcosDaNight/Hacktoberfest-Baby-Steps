...
Requirements: pygame, tkinter (pip install pygame, tkinter)
...
Tk().wm_withdraw()
messagebox.showinfo('Controls','Hit spacebar to change the color of Fidget Spinner!\nUse arrow keys to increase/decrease the speed!')
spinner()
